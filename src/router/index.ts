...
export const constantRoutes: RouteConfig[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import(/* webpackChunkName: "guide" */ '@/views/users/index.vue'),
        name: 'Users',
        meta: {
          title: 'users',
          icon: 'user',
  ...
  },
  {
    path: '/banner',
    component: Layout,
    redirect: '/explore/banner',
    children: [
      {
        path: 'index',
        component: () => import(/* webpackChunkName: "guide" */ '@/views/explore/banner.vue'),
        name: 'Banner',
        meta: {
          title: 'banner',
          icon: 'hamburger',
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import(/* webpackChunkName: "guide" */ '@/views/explore/news.vue'),
        name: 'News',
        meta: {
          title: 'news',
          icon: 'list',
  ...
  },
  {
    path: '/equip',
    component: Layout,
    redirect: '/explore/equip',
    children: [
      {
        path: 'index',
        component: () => import(/* webpackChunkName: "guide" */ '@/views/explore/equip.vue'),
        name: 'Equip',
        meta: {
          title: 'equip',
          icon: 'list',
  ...
  },
  {
    path: '/collage',
    component: Layout,
    redirect: '/explore/collage',
    children: [
      {
        path: 'index',
        component: () => import(/* webpackChunkName: "guide" */ '@/views/explore/collage.vue'),
        name: 'Collage',
        meta: {
          title: 'collage',
          icon: 'list',
